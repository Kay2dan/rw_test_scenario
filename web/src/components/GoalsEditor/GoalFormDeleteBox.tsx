...
export interface GoalChoreFormDeleteBoxFCPropTypes {
  index: number;
  removeForm: (index: number) => void;
  setShowConfirmBoxBeforeDelete: (stateTo: boolean) => void;
}

const GoalChoreFormDeleteBox: FC<GoalChoreFormDeleteBoxFCPropTypes> = ({
  index,
  removeForm,
...
export default GoalChoreFormDeleteBox;
